...
Item {
  ...
  // TENEBRIS keeps the lock artwork separate from the rotating desktop papers.
  readonly property string currentBackgroundLink: stateHome + "/omarchy/current/theme/unlock.png"
