...
Item {
  ...
  property int contentMargin: Math.max(Style.spacing.panelPadding, Style.space(18))
  ...
  PanelWindow {
    ...
    BorderSurface {
      ...
      // Hand-painted TENEBRIS surface. The texture owns atmosphere only;
      // functional borders and corners remain separate so variable-height
      // submenus never stretch the gothic line work.
      BorderImage {
        anchors.fill: parent
        source: Qt.resolvedUrl("assets/gothic_menu_surface.png")
        border.left: 64
        border.top: 72
        border.right: 64
        border.bottom: 72
      ...
      Image {
        ...
        source: Qt.resolvedUrl("assets/divider_framed.png")
      ...
      Item {
        ...
        Image {
          ...
          source: Qt.resolvedUrl("assets/frame_corner.png")
